      ...
      >
        <div className="p-4 mt-4">
          <div className="flex justify-between items-center mb-4">
            ...
            >
              <i className="ri-xrp-fill bg-primary text-white"></i>
            </button>
          </div>
              ...
              products.map((item, index) => (
                ...
                >
                  <div className="flex items-center">
                    <span className="mr-4 px-1 bg-primary text-white rounded-full text-xs">
                      0{index + 1}
                    </span>
                    <img
                      src={item.image}
                      alt=""
                      className="size-14 object-cover mr-4"
                    />
                    <div>
                    ...
                    <div className="flex flex-col items-center gap-2 ml-8">
                      <div className="flex flex-row md:justify-start justify-end items-center mt-2">
                        ...
                        className="size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary hover:text-white transition 800ms">
                          -
                        </button>
